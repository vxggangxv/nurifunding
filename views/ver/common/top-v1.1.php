      ...
      <div class="container header-box">
        ...
        <div class="navbar-collapse pull-right hidden-xs">
          <ul class="main-nav clearfix">
			...
			<li class="hidden-xs hidden-sm hidden-margin"></li>
			<li><a href="http://www.miripay.co.kr/" target="_blank">미리페이</a></li>
			<!--<li class="hidden-xs hidden-sm hidden-margin"></li>
    ...
    <section class="mlnb-wrap show-xs" id="mlnb-wrap">
      <div class="mlnb-container">
        ...
        <ul class="mlnb">
	      ...
	      <li><a href="http://www.miripay.co.kr/" target="_blank">미리페이<img src="<?=base_img2;?>/arrow_r_icon.png" alt="바로가기"></a></li>
          <li>
